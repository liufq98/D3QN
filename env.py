...
'''
        s_i=np.array([1,2,3])
        agent_0.chooseaction(s_i[0])
        agent_1.chooseaction(s_i[1])
        agent_0.chooseaction(s_i[0],s_i[3],s_i[6])
        agent_1.chooseaction(s_i[1],s_i[4],s_i[7])
        agent_2.chooseaction(s_i[2],s_i[5],s_i[8])
'''